...
\newline
\newline
\indent Debido a que el r\'egimen de la Universidad Sim\'on Bolívar es
...
una secci\'on. A cada secci\'on le corresponder\'a un aula, un horariom
un profesor y un determinado n\'umero de estudiantes. De las aulas interesa conocer el n\'umero (o nombre, si es un laboratorio, sala de reuniones o un aula no convencional), edificio donde se encuentra y capacidad. De los profesores se desea almacenar su nombre, su n\'imero de c\'edula, departamento al que pertenece, n\'umero de tel\'efono y correo electr\'onico. 
\newline
\newline	
\indent Para que los estudiantes puedan cursar una asignatura, es menester contar con su nombre, su carné, correo electrónico, fecha de nacimiento y número de teléfono. Así mismo, es necesario que se satisfagan ciertas restricciones como que el número de asignaturas inscritas por un determinado estudiante no estén por encima del límite de créditos (16), ni por debajo (8) y, en caso de hacerlo, ha de contar con los permisos necesarios. De la misma manera, ciertas asignaturas requieren que se hayan cursado otras con anterioridad para que ésta pueda ser inscrita (esto es, están preladas por otras asignaturas), por lo que es necesario contar con un registro de asignaturas cursadas para cada estudiante, con la finalidad de poder garantizar esta restricción.
\newline
\newline
...
carreras, deebe ser reservada previamente a su inscripci\'on. 
\newline
\newline
\indent Por otro lado, en el per\'iodo Septiembre-Diciembre de cada
año, es menester cancelar el Arancel de Inscripci\'on Anual, sin el
cual, es inviable que los estudiantes empiecen un nuevo año de
...
inscripci\'on, ha de ser posible realizar búsquedas o consultas de
