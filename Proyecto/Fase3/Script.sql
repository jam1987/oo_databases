...
create or replace type telefono_t as varray(5) of int;
/

REM Definicion del tipo dia_t : Arreglo de nombres de los dias de la semana
create or replace type dia_t as varray(3) of varchar(7);
/
...
create or replace type almacenar_guias_t under solicitud_servicio_t(
	nombre_guia varchar(20),
	tema_guia varchar(10),
	categoria_guia varchar(10),
...
REM Definicion del tipo libros: 
create or replace type libros_t as table of libro_t;
/
...
create table guia of guia_t(
    ...
    archivo not null,
	constraint pk_guia primary key (nombre,fecha));
	
REM Definicion de la tabla Persona
REM Se le agrega el conjunto de servicios que puede utilizar
REM esta persona
REM Nota: Esto llevaria a muchos datos duplicados... replantear
...
REM Definicion de la tabla Profesor

create table profesor of profesor_extension_t (
	cedula primary key,
	nombre_completo not null)
	nested table servicios_p store as servicios_profesor;

create table horarios of horario_t;
...
create table prestamo of prestamo_libros_t;
